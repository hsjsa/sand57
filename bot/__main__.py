...
def start(update, context):
    ...
    buttons.buildbutton("Channel", "https://t.me/superior_mirror")
...
'''
        ...
        sendMarkup('𝐍𝐨𝐭 𝐀𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐔𝐬𝐞𝐫. 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 <b>@sup_x03</b>', context.bot, update, reply_markup)

def restart(update, context):
    restart_message = sendMessage("𝐑𝐞𝐬𝐭𝐚𝐫𝐭𝐢𝐧𝐠..🔧", context.bot, update)
    if Interval:
        Interval[0].cancel()
    alive.kill()
...
def main():
    ...
    if os.path.isfile(".restartmsg"):
        ...
        bot.edit_message_text("<b>The Bot Is Booted And Ready For Use</b> \n<b>If You were Mirroring then Mirror Again.</b>", chat_id, msg_id)
        os.remove(".restartmsg")
    elif OWNER_ID:
        try:
            text = "<b>The Bot Is Booted And Ready For Use</b> \n<b>If You were Mirroring then Mirror Again.</b>"
